  ...
  describe("Determine the sequence of an array of numbers: ", function() {
    ...
    describe("Case for a geometric sequence", function() {
      ...
      it("should return `Geometric` for[3, 6, 12, 24, 48] ", function() {
        expect(myApp.aritGeo([3, 6, 12, 24, 48])).toEqual('Geometric');
      });
    ...
    describe("Case for neither arithmetic nor geometric sequence", function() {
      ...
      it("should return -1 for [1, 2, 7, 8, 10] ", function() {
        expect(myApp.aritGeo([1, 2, 7, 8, 10])).toEqual(-1);
      });

      it("should return -1 for [10, 13, 14, 17, 25] ", function() {
        expect(myApp.aritGeo([10, 13, 14, 17, 25])).toEqual(-1);
      });
